...
SONAR_FEATURE_VERTICAL_TOPIC = SLAM_NS + "feature_extraction/feature_vertical"
SONAR_FEATURE_VERTICAL_IMG_TOPIC = SLAM_NS + "feature_extraction/feature_vertical_img"
